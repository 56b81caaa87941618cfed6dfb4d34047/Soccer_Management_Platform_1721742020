...
*/
Vue.component("simple_footer_component_1721742026", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            SoccerMate - Your Ultimate Soccer Companion
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay connected with the beautiful game. SoccerMate brings you live scores, news, stats, and more from your favorite clubs and leagues around the world.
                    </div>
                </div>
            </div>
        </footer> 
